        ...
        <div className={`cf-layer ${isClosing ? "is-closing" : ""}`} aria-live="polite">
            ...
            >
                ...
                <header className="cf-header">
                    <div className="cf-header-left">
                        ...
                        <div className="cf-header-text">
                            ...
                            <p>
                                Se detectaron sobrecargas de horas en multiples actividades. Revisa cada conflicto antes de continuar.
                            </p>
                        </div>
                    </div>
                </header>
                    ...
                    {conflicts.map((conflict) => {
                        ...
                        return (
                            <article key={conflict.id} className={`cf-item ${isExpanded ? "is-expanded" : ""}`}>
                                ...
                                <div className={`cf-item-details-shell ${isExpanded ? "is-open" : ""}`} aria-hidden={!isExpanded}>
                                    <div className="cf-item-details">
                                        ...
                                        {conflict.subtasks.length ? (
                                            ...
                                            <div className="cf-empty-detail">
                                                No se encontraron subtareas detalladas para esta fecha, pero el backend reporta una sobrecarga activa.
                                            </div>
                                        )}
                ...
                <footer className="cf-footer">
                    <div className="cf-footer-status">Revisa cada conflicto y aplica una solucion cuando quieras.</div>
                </footer>
                ...
                {resolver && (
                    <div className="cf-resolver-layer" onClick={() => !resolverSaving && setResolver(null)}>
                        <div className="cf-resolver-card" onClick={(event) => event.stopPropagation()}>
                            <h3>
                                {resolver.mode === "date" ? "Cambiar fecha de subtarea" : "Reducir horas de subtarea"}
                            </h3>
                            <p>
                            ...
                            {resolver.mode === "date" ? (
                                <input
                                    ...
                                    onChange={(event) => setResolver((prev) => (prev ? { ...prev, value: event.target.value } : prev))}
